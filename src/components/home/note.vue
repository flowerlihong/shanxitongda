...
export default {
  ...
  methods:{
      ...
      showDetail(index){
          ...
          this.$router.push({name:'noteDetails',query:{Id:_this.newsData[index].Id}})
      },
    ...
    var url = "/admin/appAgentAction!runAgent.action?agentId=Agent_SCHD_Index_Data_Leader&appId=SCHD&operateType=getMailbox2";
