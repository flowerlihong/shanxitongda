  ...
  <div class="maimForm">
    <div class="wrap">
      ...
      <div
        ...
        style="padding-left: 10px;border-top:1px solid #eee"
      >
        <div class="weui-cell__hd"><span>主题</span></div>
        <div class="weui-cell__bd">
...
export default {
  ...
  methods: {
    queryDetals() {
      ...
      // })
        this.util.post(
          '/admin/appAgentAction!runAgent.action?agentId=Agent_SCHD_Index_Data_Leader&appId=SCHD&operateType=getMailbox',
          {
            Type: 'file',
            Id: _this.Id,
            userId: _this.userId,
          ...
          function(res) {
            for(var i = 0; i < res.data.length; i++) {
              ...
              // console.log(res.data[i].Id,123);
              console.log(res.data[i],123);
              ...
              _this.newsDetails.depart = res.data[i].zt
            }
