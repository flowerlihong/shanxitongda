                    ...
                    <div class="facebook-date">
                      ...
                      <span class=" c999 title-item infoItems-right">
                        ...
                        <span
                          :class="{
                            'color-content': true,
                            'color-red': item.inspectionResult == '不合格'
                          }"
                        >
...
export default {
  ...
  methods: {
    ...
    querryData(type, start) {
      ...
      this.util.post(
        '/admin/appAgentAction!runAgent.action?agentId=Agent_Wechat_xaxi&appId=WeChat&Type=safety',
        params,
        function(res) {
          console.log('dfgfg', res)
