  ...
  <div class="maimForm">
	  <div class="wrap">
			...
			<div class="weui-cell weui-cell_select  myCell" 
				...
				<div  class="weui-cell__bd myCell-bd"  @click="isReadOnly?'': selectPro('分公司')">
			...
			<div class="weui-cell weui-cell_select  myCell" 
				...
				<div  class="weui-cell__bd myCell-bd"  @click="isReadOnly?'': selectPro('施工队')">
					<span style="padding-right:5px;">
						{{qualityDetails.sgd}}						
					</span>
			...
			<mt-popup v-model="selectProjModel.fgs" position="right" popup-transition="popup-fade" style="width:100%;height:100%">
				
				<SelectProj :theUrl="selectProjModel.fgsUrl" :showWord="selectProjModel.fgsShowWord" :mess="selectProjModel" v-on:selectProjCallback="acceptProj" ref="projfile" ></SelectProj>
			</mt-popup>
...
export default {
  ...
  data() {
    return {
      pType:'',
      selectAttitude:'',
      showWord: "projectName",
      theUrl:'',
      // theUrl: "/admin/appAgentAction!runAgent.action?agentId=Agent_Wechat_xaxi&appId=WeChat&Type=construction",
      qualityDetails: {
				fgs: "", // 分公司
				sgd:'',//施工队
      ...
      selectProjModel: {
        ...
        fgs: false,
        fgsShowWord:'DepartName',
        fgsUrl: '/admin/appAgentAction!runAgent.action?agentId=Agent_Wechat_xaxi&appId=WeChat&Type=depart',
        sgd: false,
        sgdShowWord:'sgdmc',
      ...
      Id: "",
      sqlTableName: "U016_YGRZAQJY",
      symbol: "sn,YGRZAQJY",
      formId: "DForm_U016_YGRZAQJY",
      appId: "U016",
      subFormData: [],
      pushData: {},
      userId: ""
  ...
  methods: {
    ...
    selectPro(attitude) {
      let vm = this;
      if(attitude == '分公司'){        
        vm.selectProjModel.fgs = true;
        vm.selectAttitude = '分公司'
      }
      if(attitude == '施工队'){
    ...
    acceptProj(data) {			
      let vm = this;
      console.log(vm.selectAttitude)  
      console.log(data)   
      this.selectProjModel.fgs = false
      this.selectProjModel.sgd = false
      if(vm.selectAttitude == '分公司'){
        vm.qualityDetails.fgs = data.DepartName;
      }
    ...
    checkValid() {
      let vm = this;
      if (!this.validUtil.isNotEmpty(vm.pushData.fgs)) {
        this.util.failueToast("请选择分公司！");
        return false;
      }
