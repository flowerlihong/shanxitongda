<template>
  <div class="maimForm">
	  <div class="wrap">
			...
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">立项名称<span style="color:red">*</span></span></div>
			...
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">订单（工程）名称<span style="color:red">*</span></span></div>
				
				<div  class="weui-cell__bd myCell-bd">
					<span style="padding-right:5px;">
						{{qualityDetails.ddgcmc}}						
					</span>					
				</div>
			</div>
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">分公司<span style="color:red">*</span></span></div>
			...
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">管理部门<span style="color:red">*</span></span></div>
			...
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">项目经理<span style="color:red">*</span></span></div>
			...
			<div class="weui-cell  myCell" 
				...
				<div class="weui-cell__bd " >	
					<datetime title=""  class="col-xs-12 be-check" :readonly="isReadOnly" 
						  v-model="qualityDetails.jcrq" style="padding:0px;padding-right:15px;" 
			...
			<div class="weui-cell  myCell" 
				 style="padding-left: 10px;padding-right:0px;border-top:1px solid #eee">
				<div class="weui-cell__hd"><span class="itemName">是否需要整改<span style="color:red">*</span></span></div>
				<div class="weui-cell__bd " >		
			...
			<div  style="text-align:left;">
				<x-textarea  :max="500" style="width: 100%;"  :readonly="isReadOnly"
							 placeholder="请输入检查内容..."	v-model="qualityDetails.jcnr"
...
export default {
  ...
  data() {
    return {
      ...
      Id: "",
      sqlTableName: "U016_AQJC",
      symbol: "sn,AQJC",
      formId: "DForm_U016_AQJC",
      appId: "U016",
      subFormData: [],
      pushData: {},
      userId: ""
  ...
  activated() {
    ...
    if(this.pType == 'detail'){
      ...
      console.log('ddddd',this.qualityDetails)
			this.qualityDetails.jcrq = this.util.isNotEmpty(data.DocCreated)?data.DocCreated.substr(0,11):''; //是否通过
			this.qualityDetails.sfxyzg = this.util.isNotEmpty(data.sfxyzg)?[data.sfxyzg]:['']; //是否通过
			this.qualityDetails.inspectionResult = this.util.isNotEmpty([data.inspectionResult])?[data.inspectionResult]:undefined;
    }
  },
  methods: {
    queryDetals() {
      ...
      this.util.post(
        ...
        function(res) {
          ...
          _this.qualityDetails.administrativeDepartment =
            data.administrativeDepartment;
          _this.qualityDetails.projectJi = data.projectJi;
          // _this.qualityDetails.jcnr = data.jcnr;
    ...
    acceptProj(data) {
      ...
      this.qualityDetails.fgs = data.fgs;
      this.qualityDetails.sgd = data.sgd;
      this.qualityDetails.lxh = data.lxh;
      this.qualityDetails.lxmc = data.lxmc;
      this.qualityDetails.ddgcmc = data.ddgcmc;
      this.qualityDetails.zdmc = data.zdmc;
      this.qualityDetails.zdId = data.zdId;
      this.qualityDetails.xmjl = data.xmjl;
      this.qualityDetails.glbm = data.glbm;
      this.qualityDetails.sfxyzg = this.util.isNotEmpty(data.sfxyzg)?[data.sfxyzg]:['']; //是否通过
