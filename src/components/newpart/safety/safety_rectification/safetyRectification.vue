                                ...
                                <div class="card-header no-border">
                                    ...
                                    <div class="facebook-date">
                                        <span class=" c999 title-item "> 
                                            立项号:
                                            <span class="color-content" style="display:block;float:right">                                                
                                                {{item.lxh == undefined?'':(item.lxh.length>35?item.lxh.substr(0,35)+'...':item.lxh)}}
                                            </span>                                           
                                        </span>                                      
                                    </div> 
                                    ...
                                    <div class="facebook-date">
                                        <span class=" c999 title-item "> 
                                            分公司:
                                            <span class="color-content" style="display:block;float:right">                                                
                                                {{item.fgs == undefined?'':(item.fgs.length>35?item.fgs.substr(0,35)+'...':item.fgs)}}
                                            </span>                                           
                                        </span>                                      
                                    </div> 
                                    <div class="facebook-date">
...
export default {
  ...
  methods: {
    ...
    querryData(type, start) {
      ...
      this.util.post(
        "/admin/appAgentAction!runAgent.action?agentId=Agent_Wechat_xaxi&appId=WeChat&Type=rectify",
        params,
        function(res) {
          console.log(res);
          _this.qualityData =
            type == 1 ? _this.qualityData.concat(res.data.data) : cloneObj(res.data.data);
