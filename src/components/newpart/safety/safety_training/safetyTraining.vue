                                ...
                                <div class="card-header no-border">
                                    ...
                                    <div class="facebook-date">
                                        <span class=" c999 title-item "> 
                                            施工队:
                                            <span class="color-content" style="display:block;float:right">                                                
                                                {{item.sgd == undefined?'':(item.sgd.length>35?item.sgd.substr(0,35)+'...':item.sgd)}}
                                            </span>                                           
                                        </span>                                      
                                    </div> 
...
export default {
  ...
  methods: {
    ...
    querryData(type, start) {
      ...
      this.util.post(
        "/admin/appAgentAction!runAgent.action?agentId=Agent_Wechat_xaxi&appId=WeChat&Type=safetyTra",
        params,
        function(res) {
          console.log(res);
          _this.qualityData =
