    ...
    <scroller lock-x scrollbar-y use-pullup use-pulldown height="-62" 
      ...
      <div class="box2">
        <swipeout>
            ...
            <div slot="right-menu" v-if="val.lock == null">
            ...
            <div slot="content" class="demo-content vux-1px-t">
                    ...
                    <div class="infos">
                      ...
                      <div class="others">
                        ...
                        <div class="date">{{val.fsrq}}</div>
                      </div>
                    </div>
                    <div class="status">
                      <div v-if="val.lock==null" class="status-line bg-red">未审</div>
...
export default {
  ...
  methods: {
    ...
    addData() {
      this.util.gotoByName("progressDetail", {});
    }
  },
  data() {
    return {
