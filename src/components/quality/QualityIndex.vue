<template>
  <div>
    <div @click="goto('checkBillList')" style="overflow: hidden;" class="ibox">
      
      <div class="ibox-title" style="border-color: #FC8675;border-bottom: 1px solid #F3CE85;">
        <span class="glyphicon glyphicon-leaf"></span>
        <p class="ibox-title-icon">质量检查({{checkCount==undefined? 0:checkCount}})</p>
      </div>
  </div>
	<div @click="goto('improveBillList')" style="overflow: hidden;" class="ibox">
      <div class="ibox-title" style="border-color: #666699;border-bottom: 1px solid #666699;">
        <span class="glyphicon glyphicon-list-alt"></span>
        <p class="ibox-title-icon">质量整改({{improveCount==undefined? 0:improveCount}})</p>
      </div>
    </div>
  ...
  methods: {
    ...
    loadData(){
      this.util.mask();
				var _this=this;
				var param = {
						operateType:'getQualityStatisticsCount',
