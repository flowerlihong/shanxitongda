                ...
                >
                  ...
                  <div class="card-header no-border">
                    <div class="facebook-date head-ft16">
                      <span class=" ft14" style="color:#8994d2">{{
                        item.projectName == undefined
                          ? ''
                          : item.projectName.length > 19
                          ? item.projectName.substr(0, 19) + '...'
                          : item.projectName
                      }}</span>
                    </div>
                    ...
                    <div class="facebook-date">
                      <span class=" c999 title-item ">
                        ...
                        <span
                          class="color-content"
                          style="display:block;float:right;font-size:12px;"
                        >
                          {{
                            item.gznr == undefined
                              ? ''
                              : item.gznr.length > 20
                              ? item.gznr.substr(0, 20) + '...'
                              : item.gznr
                          }}
                        </span>
                      </span>
...
export default {
  ...
  methods: {
    ...
    showDetail(index,item) {
      ...
      this.$router.push({
        name: 'workLogInfo',
        query: { pType: 'detail', Id: _this.qualityData[index].Id},params: {data: item }
      })
    },
