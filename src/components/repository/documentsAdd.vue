    ...
    <group>
      ...
      <cell-box>
        <div class="wrap-times">
          <div class="field">类型名称</div>
          <input
            v-model="mainFormData.periodsNum"
            style="text-align: right;margin-left: 105px;"
            type="string"
